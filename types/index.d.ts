...
declare namespace CookieConsent {
  ...
  interface CookieConsentConfig {
     ...
     */
    onFirstConsent?: (param: { cookie: CookieValue }) => void;

    /**
     * Callback fired on the very first consent action
     * and on each page load.
     */
    onConsent?: (param: { cookie: CookieValue }) => void;
     ...
     */
    onModalShow?: (param: { modalName: ModalName }) => void;

    /**
     * Callback fired when one of the modals is hidden.
     */
    onModalHide?: (param: { modalName: ModalName }) => void;
  ...
  function showBTS(): void;

  function hideBTS(): void;
   ...
   */
  function getCookie<Field extends keyof CookieValue>(
    field: Field
  ): CookieValue[Field];
   ...
   * @returns value of the specified field
   */
  function getConfig<Field extends keyof CookieConsentConfig>(
    field: Field
  ): CookieConsentConfig[Field];
